...
import one from '@/views/Login/images/1.png'
import two from '@/views/Login/images/2.png'
import three from '@/views/Login/images/3.png'
import four from '@/views/Login/images/4.png'
